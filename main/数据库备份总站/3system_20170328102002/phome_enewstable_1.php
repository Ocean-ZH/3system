...
E_D("replace into `phome_enewstable` values('9','banner','幻灯数据表','幻灯数据表','0',',1,','1','0','9','0');");
E_D("replace into `phome_enewstable` values('10','other','其他站点数据表','其他站点数据表','0',',1,','1','0','10','0');");
